...
function calc_sin(){
     ...
     if (selection == "rad"){
       ...
       document.form.textinput.value = Math.sin(text * (Math.PI / 360))
     }
   }
...
function calc_cos(){
   ...
   if (selection == "rad"){
     ...
     document.form.textinput.value = Math.cos(text * (Math.PI / 360))
   }
 }
...
function calc_tan(){
   ...
   if (selection == "rad"){
     ...
     document.form.textinput.value = Math.tan(text * (Math.PI / 360))
   }
 }
